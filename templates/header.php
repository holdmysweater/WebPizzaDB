...
<body>
<nav class="nav wrapper small justify-content-between align-items-center border-bottom py-2">
    <div class="d-flex align-items-center">
        <a class="nav-link text-black-hover-orange ps-1 d-flex align-items-center" aria-current="page" href="#">
            <div class="rounded-circle" style="background: red; width: 8px; height: 8px;"></div>
            <p class="m-0 ms-1">Прямой эфир</p>
        </a>
        <a class="nav-link text-black-hover-orange ps-1" aria-current="page" href="#">Работа в Додо</a>
        <a class="nav-link text-black-hover-orange ps-1" aria-current="page" href="#">О нас</a>
        <a class="nav-link text-black-hover-orange ps-1" aria-current="page" href="#">Контакты</a>
        <a class="nav-link text-black-hover-orange ps-1" aria-current="page" href="#">Корпоративные заказы</a>
    </div>
    <?php if (null === $currentUser): ?>
        <div class="d-flex flex-column align-items-end">
            <span>Вы не авторизованы</span>
            <div class="d-flex">
                <a class="text-orange hover-darkorange" href="/login.php">Ввести логин и пароль</a>
                <span class="mx-1">или</span>
                <a class="text-orange hover-darkorange" href="/signup.php">зарегистрироваться</a>
            </div>
        </div>
    <?php else: ?>
        <div class="d-flex align-items-center gap-2">
            <span>Вы авторизованы как <span class="text-orange"><?php echo $currentUser['email'] ?></span></span>
            <input type="submit" name="logout" value="Выйти" class="btn btn-dark hover-orange py-1" style="font-size: 14px;">
        </div>
    <?php endif; ?>
</nav>
<header class="wrapper d-flex justify-content-between align-items-center mt-2">
    <div class="d-flex">
        <div class="d-flex flex-column me-5">
            ...
            <div class="d-flex ms-5 flex-column small">
                ...
                <p class="small m-0 text-orange">по количеству пиццерий</p>
            </div>
        </div>
        <div class="d-flex flex-column">
            <div>
                <span class="m-0 fs-5">Доставка пиццы</span>
                <a class="link-underline link-underline-opacity-0 m-0 fs-5 text-orange" aria-current="page" href="#">Волгоград</a>
            </div>
            <div class="d-flex align-items-center">
    ...
    <div class="d-flex flex-column mx-4 text-black-hover-orange">
...
<nav class="wrapper bg-white d-flex align-items-center justify-content-between position-sticky sticky-top py-1 shadow-sm">
    <div class="nav small align-items-center py-2">
        <a class="nav-link text-black-hover-orange ps-1" aria-current="page" href="#">Пиццы</a>
        <a class="nav-link text-black-hover-orange ps-1" aria-current="page" href="#">Комбо</a>
        <a class="nav-link text-black-hover-orange ps-1" aria-current="page" href="#">Закуски</a>
        <a class="nav-link text-black-hover-orange ps-1" aria-current="page" href="#">Коктейли</a>
        <a class="nav-link text-black-hover-orange ps-1" aria-current="page" href="#">Кофе</a>
        <a class="nav-link text-black-hover-orange ps-1" aria-current="page" href="#">Напитки</a>
        <a class="nav-link text-black-hover-orange ps-1" aria-current="page" href="#">Десерты</a>
        <a class="nav-link text-black-hover-orange ps-1" aria-current="page" href="#">Соусы</a>
        ...
        <a class="nav-link text-black-hover-orange ps-1 ms-1" aria-current="page" href="#">Акции</a>
    </div>
